<?php
		...
		$gen=$row1[4];
		$smoke=$row1[5];
		$sql="SELECT * FROM table_1 WHERE Coverage_Term=$year AND Gender='$gen' AND Smoker_Status='$smoke' AND Coverage_Amount=$range AND Age=$age";
    	...
    	while($row=mysqli_fetch_row($result))
    	{
    		...
    		$output.='<div class="row w-100 align-items-center mt-4 mb-4">
            <div class="border bg-light border-primary rounded w-100 align-items-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col text-center">
                            <div class="bg-success p-2 text-center rounded">
                                <p class="text-light h6">Express Process</p>
                            </div>
                        </div>
                        <div class="col text-center">
                            <p class="h1 mb-0">$'.$row[7].'</p>
                            <p class="mt-0">per month</p>
                        </div>
                        <div class="col text-center">
                            <a href="apply.php?policy='.$row[0].'"><button class="btn btn-primary rounded-cirlce">
                                APPLY NOW</button></a>
                            </button>
                        </div>
                    </div>
